...
static const CGFloat    kDefaultMessageImageWidth   = 44;
static const CGFloat    kDefaultMessageImageHeight  = 44;
...
//    self.imageView2.style=[TTShapeStyle styleWithShape:
//                             [TTRoundedRectangleShape shapeWithRadius:8]
...
- (void)layoutSubviews {
  ...
  if (_titleLabel.text.length) {
    _titleLabel.frame = CGRectMake(left, top, width-15, _titleLabel.font.ttLineHeight);
  ...
  if (self.captionLabel.text.length) {
    self.captionLabel.frame = CGRectMake(left, top, width-15, self.captionLabel.font.ttLineHeight);
  ...
  if (self.detailTextLabel.text.length) {
    ...
    self.detailTextLabel.frame = CGRectMake(left, top, width-15, textHeight);
  ...
  if (_timestampLabel.text.length) {
    ...
    _timestampLabel.left = self.contentView.width - (_timestampLabel.width + kTableCellSmallMargin)-10;
