  ...
  if (caption) {
    if (!_captionLabel) {
      ...
      [self addSubview:_captionLabel];
        ////////////////
        _userIconImage=[[TTImageView alloc]  initWithFrame:CGRectMake(5, 5, 32, 32)];
        UIImage* image = [UIImage imageNamed:@"defaultUserIcon.png"];
        [_userIconImage setImage:image];
        [_captionLabel addSubview:_userIconImage];
    }
  }
