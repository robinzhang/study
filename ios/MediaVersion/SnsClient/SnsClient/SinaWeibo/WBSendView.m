...
- (void)keyboardWillShow:(NSNotification*)notification {
	...
	if (UIInterfaceOrientationIsLandscape(orientation)) {
        ...
        //NSLog(@"oldframe.origin.y >> %f",oldframe.origin.y);
        _panelView.frame = CGRectMake(oldframe.origin.x, 5, oldframe.size.width, oldframe.size.height); 
...
- (void)keyboardWillHide:(NSNotification*)notification {
	...
	if (UIInterfaceOrientationIsLandscape(orientation)) {
        ...
        CGRect oldframe = _panelView.frame;
        //NSLog(@"oldframe.origin.y >> %f",oldframe.origin.y);
        _panelView.frame = CGRectMake(oldframe.origin.x, 63, oldframe.size.width, oldframe.size.height); 
