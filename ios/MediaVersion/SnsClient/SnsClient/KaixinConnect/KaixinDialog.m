...
static CGFloat kKaixinRed[4] = {0.7, 0.2, 0.2, 1.0};
...
static NSString* kRedirectURL = @"http://www.kanguo.com";//用申请的url填充
///////////////////////////////////////////////////////////////////////////////////////////////////

BOOL KaixinIsDeviceIPad() {
...
- (NSURL*)generateURL:(NSString*)baseURL params:(NSDictionary*)params {
  if (params) {
    ...
    for (NSString* key in params.keyEnumerator) {
      ...
      [pairs addObject:[NSString stringWithFormat:@"%@=%@", key, value/*escaped_value*/]];
...
- (void)drawRect:(CGRect)rect {
  ...
  [self drawRect:headerRect fill:kKaixinRed radius:0];
    ...
    if ([[url absoluteString] hasPrefix:kRedirectURL])
    {
        if ([[url.resourceSpecifier substringToIndex:8] isEqualToString:@"//cancel"]) {
            ...
            if (errorCode) {
                ...
                NSError * error = [NSError errorWithDomain:@"KaixinErrDomain"
...
- (void)show {
  ...
  _closeButton.frame = CGRectMake(
    self.frame.size.width - kBorderWidth,kBorderWidth,0,0);
